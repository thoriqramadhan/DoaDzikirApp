package com.thoriqramadhan.doadzikirapp.model
...
object DataDoaDzikir {
        ...
        get() {
            ...
            for (index in titleQauliyah.indices) {
                val data = DoaDzikirItem(
                    titleQauliyah[index], arabicQauliyah[index], translateQauliyah[index]
                )
                listData.add(data)
            }
            return listData
    ...
    fun listDzikir(): List<DoaDzikirItem>{
        ...
        for (index in titleDzikir.indices) {
            val data = DoaDzikirItem(
                titleDzikir[index], arabicDzikir[index], translateDzikir[index]
            )
            listData.add(data)
        }
        return listData
    ...
    fun listDzikirPagi(): List<DoaDzikirItem>{
        ...
        for (Index in titleDzikirPagi.indices) {
            val data = DoaDzikirItem(
                titleDzikirPagi[Index], arabicDzikirPagi[Index], translateDzikirPagi[Index]
            )
            listData.add(data)
        }
        return listData
    ...
    fun listDzikirPetang(): List<DoaDzikirItem>{
        ...
        for (index in titleDzikirPetang.indices) {
            val data = DoaDzikirItem(
                titleDzikirPetang[index], arabicDzikirPetang[index], translateDzikirPetang[index]
            )
            listData.add(data)
        }
        return listData
